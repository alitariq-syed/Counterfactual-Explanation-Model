...
parser.add_argument('--resume_from_epoch' ,default = 6, type=np.int32)## False = train CF model from scratch; True = resume training CF model
...
parser.add_argument('--cfe_epochs', default = 9, type = np.int32 ) #100 for mnist, 200 for CUB
