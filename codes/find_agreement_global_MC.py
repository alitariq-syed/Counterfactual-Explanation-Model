...
def find_agreement_global_MC(pred_MC,target_class, args, class_name, class_weights):
...
#%%
    ...
    mag_similarity = -np.sum(abs(a-b)*pred_MC_binary) #lower is better; but with -neg sign, higher is better
